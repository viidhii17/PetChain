...
theme: "colored", 
  ...
  <p className='md:w-96 text-sm text-center'>By continuing, you agree to PetChain's <span className='font-bold'>Terms of Service</span>; Opens a new tab and acknowledge you've read our Privacy Policy; Opens a new tab. </p>
  {/* {
