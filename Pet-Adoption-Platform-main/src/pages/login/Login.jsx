...
const axiosPublic=useAxiosPublic();
  ...
  <p className="mt-3 block text-yellow-900 text-base font-normal text-warning  text-center">
  ...
  <div className='w-6/12 h-8/12 rounded-lg relative'>
            ...
            <div className="relative">
              ...
              <p className="absolute top-1/2 left-1/2 transform -translate-x-1/2 text-center text-white -translate-y-1/2 text-lg lg:text-3xl  ">
                Welcome to <span className='lg:text-4xl text-xl text-yellow-600 px-4 py-2 rounded-md font-bold'>PetChain</span> An Enhanced Fundraising and Adopting Platform <br />Login For Explore our Website
              </p>
            </div>
          </div>

 <div className="  mx-3 px-3 bg-white-200 border-2 border-yellow-500 rounded-lg" >
...
<form className="mt-8 mb-2 w-full max-w-screen-lg sm:w-96 px-3 py-10 shadow-md rounded-md" onSubmit={handleLogin}>
    ...
    <button
      className="relative mt-6 block w-full select-none rounded-lg bg-yellow-500 py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-yellow-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
  ...
  <p className='text-center mt-2'>OR</p>
    ...
    <FcGoogle className='hidden lg:flex absolute w-6 h-6 left-20 -mt-1'></FcGoogle> Continue with Google 
      ...
      <p className="p-2 text-sm md:p-5">Do not have an account? Please <Link to='/register' className=" text-yellow-500 font-bold">Register</Link></p>
