  ...
  const handleCategoryChange = event => {
    ...
    return (
      <div>
        <Navbar></Navbar>
        <div>
            <p className="text-5xl bg-yellow-600 text-white flex justify-center w-8/12 mx-auto border-y-2 my-20 py-7">Help them find their fur-ever Home!</p>
        </div>
        <div className='flex flex-col items-center w-full '>
         <div className="flex items-center justify-between flex-1 space-x-10">
         <div>
             {/* Search Bar */}
          <input
            type="text"
        ...
        <div className=" rounded-md h-12 w-12 border-4 border-t-4 border-yellow-600 animate-spin "></div>;
        </div>}
      >
