...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_vtvda2d', 'template_36qk4jm', form.current, 'ZE2-N94T6hzshzyDf')
      .then((result) => {
...
<img src={contact} className='w-96 header' alt="" data-aos="zoom-in-up" />
  ...
  <div data-aos='fade-up'
    ...
    <h3 className="block font-sans text-3xl antialiased font-semibold leading-snug tracking-normal  text-[#FFC000]">
     Send Message
    </h3>
  </div>
  ...
  <div className="p-6 ">
   <input type='submit' className='w-full bgg cursor-pointer text-white font-bold bg-[#FFC000]  rounded-full py-3' value='Send'/>
    {/* <button
